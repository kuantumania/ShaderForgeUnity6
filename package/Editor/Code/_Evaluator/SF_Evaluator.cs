...
namespace ShaderForge {
	...
	public class SF_Evaluator {
		...
		void BeginCG() {
			...
			if( LightmappedAndLit() ) {
				App( "#define SHOULD_SAMPLE_SH ( !defined(LIGHTMAP_ON) && !defined(DYNAMICLIGHTMAP_ON) )" );
			...
			if( LightmappedAndLit() ) {
				App( "#pragma multi_compile _ LIGHTMAP_ON" );
				App( "#pragma multi_compile _ DIRLIGHTMAP_COMBINED" );
				App( "#pragma multi_compile _ DYNAMICLIGHTMAP_ON" );
			}
